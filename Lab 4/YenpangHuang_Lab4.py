...
Cz_num = [1.002, 0.16]                  # Put your coefficients here!    
Cz_den = [1, 0.]                  

# Notch filter coeffs
Nz_num = [0.7759, -1.512, 0.7545]        # Put your coefficients here!  
Nz_den = [1, -1.512, 0.5304]   

# feedforward control element 
DC_gain = 1.01                       # DCgain of the plant to the inputs (theoretically the same for r-to-y as d-to-y) 
...
d = 1                                               # volts, disturbance input, initialized at zero  
...
### suggested edits only between this line and the ### below
        new = (Cz_num[0]*e[0] + Cz_num[1]*e[1] - Cz_den[1]*uc[0])/Cz_den[0]                 # implement difference equation here!
###                                   
...
### suggested edits only between this line and the ### below
        new = (Nz_num[0]*uf[0] + Nz_num[1]*uf[1] + Nz_num[2]*uf[2] - Nz_den[1]*uk[0] - Nz_den[2]*uk[1])/Nz_den[0]      # implement difference equation here!
###     
        new = uf[0]
        uk = [new] + uk[:-1]
