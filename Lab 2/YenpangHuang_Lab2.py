...
r_stepMag = 0.0                     # volts, reference signal step magnitude
...
# disturbance input 
d_stepMag = 1.0                     # volts, the disturbance voltage
d = 0

# Ctrl gains
kp = 0.55
ki = 0.125
kd = 0.2631                           # derivative gain
kff = 1                          # feedforward gain
